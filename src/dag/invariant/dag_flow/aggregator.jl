...
@testitem "Test evaluate without message" begin
...
@testitem "Test evaluate 2" begin
...
@testitem "Test evaluate 3" begin
...
@testitem "Testing evaluate and commit! with no message" begin
    invariant = JuLS.AggregatorInvariant()
